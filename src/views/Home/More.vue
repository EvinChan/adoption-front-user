        ...
        <div class="CategoryList">
            <div class="row">
                ...
                <div class="crumbs">
                    ...
                    <span>待领养宠物{{this.$route.query.category}}</span>
                </div>
                <!-- 排序 -->
                ...
                <div class="itemList">
                    <div class="newProduct product" v-for="(item, index) in notAdoptedList" :key="index">
                        <div class="hd">
...
<script>
  ...
  import {getNotAdopted, getOrganization} from '@/api/main';
